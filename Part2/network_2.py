    ...
    def udt_receive(self):
        ...
        if pkt_S is not None:
            ...
            if packet.flag == 0:
                result = ''
                result2 = ''
                # sorts list based on the headers, last element goes to the front of the list due to flag = 0,
                ...
                for i in range(len(receiveList)):
                    ...
                    result2 += data
                print('%s: received packets: "%s"' % (self, result2))
                print('%s: final reconstructed packet payload: "%s"' % (self, result))
